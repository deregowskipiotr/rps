  ...
  <div class="bg-gray-700 text-white  text-center min-h-screen flex flex-col">
    ...
    <main class="container mx-auto p-6 flex-1 ">
      <div v-if="choice === null" class="flex items-center justify-center -mx-6">
        <button
        @click="play('rock')"
        class="bg-white rounded-full shadow-lg w-60 p-12 mx-6 transition-colors duration-300 hover:bg-pink-500">
          <img src="./assets/misc-pet-rock.png" alt="Rock" class="w-full"/>
        </button>

        <button @click="play('paper')"
          class="bg-white rounded-full shadow-lg w-60 p-12 mx-6 transition-colors duration-300 hover:bg-green-500">
          <img src="./assets/paper.png" alt="Paper" class="w-full " />
        </button>

        <button @click="play('scissors')"
          class="bg-white rounded-full shadow-lg w-60 p-12 mx-6 transition-colors duration-300 hover:bg-yellow-500">
          <img src="./assets/rcLoRrepi.png" alt="Scissors" class="w-full " />
        </button>
      </div>
